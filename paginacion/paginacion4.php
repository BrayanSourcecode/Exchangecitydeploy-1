...
<body>
  ...
  <header id="header" >
    <div class="logo">
      <a href="/PROYECTOSENA/index.html">
  ...
  <nav id="menu">
    <div class="icono">
      <a class="menuObjeto" href="/PROYECTOSENA/index.html">
        <img class="menuIcono" src="/PROYECTOSENA/imagenes/Navegacion/svg/house.svg" alt="inicio.svg">
        <span>Inicio</span>
      </a>
    </div>
    <div class="icono">
      <a class="menuObjeto" href="televisores.html">
        <img class="menuIcono" src="/PROYECTOSENA/imagenes/Navegacion/svg/tv.svg" alt="televisores.svg">
        <span>TV</span>
      </a>
    </div>
    <div class="icono">
      <a class="menuObjeto" href="movil.html">
        <img class="menuIcono" src=/PROYECTOSENA/imagenes/Navegacion/svg/smartphone.svg" alt="movil.svg">
        <span>Movil</span>
      </a>
    </div>
    <div class="icono">
      <a class="menuObjeto" href="computadoras.html">
        <img class="menuIcono" src="/PROYECTOSENAimagenes/Navegacion/svg/pc.svg" alt="computadoras.svg">
        <span>PC</span>
      </a>
    </div>
    <div class="icono">
      <a class="menuObjeto" href="consolas.html">
